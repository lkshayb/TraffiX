    ...
    <div className='font-[work-sans]'>
      <div className='flex h-screen bg-background'>
        ...
        <div className='flex-1 overflow-auto position-relative'>
          <nav className='flex items-center justify-between position-absolute z-2 fixed top-0 w-full  px-6 py-4 bg-transparent text-white border-b-1 border-slate-600/50'>
